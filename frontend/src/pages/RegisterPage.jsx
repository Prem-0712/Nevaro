  ...
  return (
    <main className="overflow-hidden grid min-h-screen grid-cols-1 lg:grid-cols-2 bg-[#FAD93D]">
      ...
      <div className="relative hidden lg:block h-screen w-full overflow-hidden">
        <img src={logoBag1} alt="bag-1" className="absolute top-[-10%] right-[30%] rotate-40 z-10" />
        <img src={logoBag2} alt="bag-2" className="absolute top-[-3%] right-[-25%] -rotate-10 z-20" />
        <img src={normalBag} alt="bag-3" className="absolute bottom-[-10%] right-[10%] rotate-[-15deg] z-10" />
      </div>
    </main>
  );
};
