  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans overflow-hidden">
      ...
      <div className="w-48 bg-white flex flex-col py-6 px-4 shadow-sm shrink-0">
        ...
        <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-500 hover:bg-gray-100 transition-all">
          <span>🚪</span> Logout
        </button>
      </div>
                ...
                {stockLevels.map((item) => (
                  <div key={item.name}>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${stockColor(item.status)}`}
